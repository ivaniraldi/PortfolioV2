        ...
        >
            ...
            >
                ...
                >
                    ...
                    <img src="https://i.ibb.co/sPfDfYg/hexagonos.png" alt="" className={`absolute ${s.imgPhoneScreen}`} style={{ width: "20vw", bottom: "8vh", left: "70vw", transform: "rotate(-155deg)" }} />
                    ...
                    <img src="https://i.ibb.co/4MZyp5t/nodejs.png" alt="" className={`absolute ${s.imgPhoneScreen}`} style={{ width: "19vw", bottom: "8.8vh", left: "40vw", opacity: "0.4" }} />
                    ...
                    <img src="https://i.ibb.co/cNNqZgB/postgre.png" alt="" className={`absolute ${s.imgPhoneScreen}`} style={{ width: "19vw", bottom: "8.8vh", left: "10vw", opacity: "0.4" }} />
