...
― Frank Zappa.</h1>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        <p style={{ fontSize: "3.1vw" }}>
                            <ul>
                                <li className='mt-1'><img className='w-6 inline' src="https://cdn-icons-png.flaticon.com/512/1491/1491165.png" alt=" 1" /> •Strong creative ability.</li>
                                ...
                                <li className='mt-1'><img className='w-6 inline' src="https://cdn-icons-png.flaticon.com/512/1763/1763663.png" alt=" 4" /> •Good problem-solving skills.</li>
                            </ul>
                        </p>
                        ...
                        <p style={{ fontSize: "3.2vw", marginTop:"2vh" }}>
                            <ul>
                                <li>•Optimize <span className='font-bold'>graphics</span> and page speed for enhanced user experience.</li>
                                <li>•Check for <span className='font-bold'>brand consistency</span> across the website.</li>
                                <li>•Perform timely functional <span className='font-bold'>testing</span> of core website elements. </li>
